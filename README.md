# Germany Farm Subsidies MCP

[![CI](https://github.com/ansvar-systems/de-farm-subsidies-mcp/actions/workflows/ci.yml/badge.svg)](https://github.com/ansvar-systems/de-farm-subsidies-mcp/actions/workflows/ci.yml)
[![GHCR](https://github.com/ansvar-systems/de-farm-subsidies-mcp/actions/workflows/ghcr-build.yml/badge.svg)](https://github.com/ansvar-systems/de-farm-subsidies-mcp/actions/workflows/ghcr-build.yml)
...
```json
{
  "mcpServers": {
    "uk-farm-subsidies": {
      "command": "npx",
      "args": ["-y", "@ansvar/de-farm-subsidies-mcp"]
    }
  }
}
```
...
```bash
claude mcp add uk-farm-subsidies npx @ansvar/de-farm-subsidies-mcp
```

### Streamable HTTP (remote)

```
https://mcp.ansvar.eu/de-farm-subsidies/mcp
```

### Docker (self-hosted)

```bash
docker run -p 3000:3000 ghcr.io/ansvar-systems/de-farm-subsidies-mcp:latest
```

### npm (stdio)

```bash
npx @ansvar/de-farm-subsidies-mcp
```
